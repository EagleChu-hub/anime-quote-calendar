...
const VERSION = 'anime-calendar-v5';
const CORE = [
  './', 'index.html', 'manifest.webmanifest', 'css/style.css',
  'js/vendor/lunar.js', 'js/lunar-info.js', 'js/scene.js', 'js/card.js', 'js/export.js', 'js/app.js', 'js/remind.js',
  'data/festivals-tw.json', 'data/scenes.json', 'data/scenes-2.json', 'data/scenes-extra.json', 'data/tokens.json',
  'icons/icon-192.png', 'icons/favicon-32.png',
];
// 風景元素（assets/elements/*.svg）用到才快取，不在安裝時一次下載
...
self.addEventListener('push', (e) => {
  ...
  e.waitUntil(self.registration.showNotification(d.title || '空鏡日曆', {
